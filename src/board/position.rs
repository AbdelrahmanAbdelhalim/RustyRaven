...
struct StateInfo<'a> {
    ...
    materialKey: Key,
    pawnKey: Key,
    nonPawnMaterial: [Value; bb::COLORNB],
    castlingRights: i32,
    rule50: i32,
    pliesFromNull: i32,
    epSquare: Square,
    ...
    blockersForKing: [Bitboard; bb::COLORNB],
    pinners: [Bitboard; bb::COLORNB],
...
struct Position<'a> {
    board: [Piece; bb::SQNB],
    byTypeBB: [Bitboard; bb::PTNB],
    byColorBB: [Bitboard; bb::COLORNB],
    pieceCount: [i32; bb::PNB],
    castlingRIghtMast: [i32; bb::SQNB],
    castlingRookSquare: [Square; bb::CRNB],
    castlingPath: [Bitboard; bb::CRNB],
    st: &'a StateInfo<'a>,
    gamePly: i32,
    sideToMove: Color,
}
